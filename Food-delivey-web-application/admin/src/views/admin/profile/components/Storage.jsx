  ...
  return (
    <Card extra={"w-full h-full p-4"}>
      ...
      <div className="mb-auto flex flex-col items-center justify-center">
        <div className="mt-2 flex items-center justify-center rounded-full bg-lightPrimary p-[26px] text-5xl font-bold text-amber-500 dark:!bg-navy-700 dark:text-white">
          <BsCloudCheck />
        </div>
      ...
      <div className="flex flex-col">
        ...
        <div className="mt-2 flex h-3 w-full items-center rounded-full bg-lightPrimary dark:!bg-navy-700">
          <span className="h-full w-1/2 rounded-full bg-amber-500 dark:!bg-white" />
        </div>
      </div>
    </Card>
  );
